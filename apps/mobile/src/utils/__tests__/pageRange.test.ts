...
describe('pageRange Utility', () => {
  ...
  it('4. parsePageRange("abc", 10) throws', () => {
    expect(() => parsePageRange('abc', 10)).toThrow('Invalid format');
  });

  it('5. parsePageRange("1-15", 10) throws Page 15 exceeds total 10', () => {
    expect(() => parsePageRange('1-15', 10)).toThrow('Page 15 exceeds total 10');
  });
  ...
  it('7. parsePageRange("5-3", 10) throws (reverse range)', () => {
    expect(() => parsePageRange('5-3', 10)).toThrow('start page cannot exceed end page');
  });
  ...
  it('11. parsePageRange("0-3", 10) throws positive integer error', () => {
    expect(() => parsePageRange('0-3', 10)).toThrow('positive integers');
  });
